package org.rainbrurpg.transparentcupsclient.app;
...
import org.rainbrurpg.transparentcupsclient.R;
...
public class HostNotVerifiedActivity extends Activity {
    public static final String KEY_HOST = HostNotVerifiedActivity.class
	.getName() + ".ErrorText";
     ...
     * @return true if the hostname was explicitly trusted, false otherwise 
     *         or if unknown
     */
